...
function configureDropDownLists(ddl1,ddl2) {
  ...
  //play/pause of the video when the modal opens/closes. 
    $('.videomodal').on('show.bs.videomodal', function() { //show modal event for an element which has class 'modal'
    ...
    $('.videomodal').on('hidden.bs.modal', function() { //show modal event for an element which has class 'modal'
